Bootstrap CSS Modal Ajax Windows
===============
...
Notice in the above, that the *[options]* collection above, is a name/value collection, where the name becomes the friendly displayed
